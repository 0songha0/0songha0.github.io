var store = [{
        ...
        "excerpt":"부하테스트 서버 생성 이유 테스트하려는 시스템과 부하테스트 툴은 반드시 독립적으로 분리해서 구성해야 합니다. 부하테스트 툴이 컴퓨팅 리소스 (CPU, 메모리) 를 사용해서 트래픽을 만들어내기 때문입니다. Windows 또는 Mac OS 개인 컴퓨터는 부하를 발생시킬 때 제한 이 걸릴 때가 종종 있으므로, 부하테스트는 EC2 인스턴스를 생성해 Linux 환경에서 진행하는 것을 권장합니다. EC2 서버에...","categories": ["test"],
        "tags": [],
