var store = [{
        ...
        "title": "CS 면접, 코딩테스트를 위한 알고리즘 개념 및 Java 코드 정리",
        "excerpt":"알고리즘 도감 앱을 함께 보면, 각 알고리즘 동작을 그림으로 쉽게 이해하고 복습하기 좋습니다. 정렬 알고리즘 정의된 순서대로 데이터를 나열하는 방법입니다. 선택 정렬 리스트에서 최소값을 선택하고 맨 앞에 위치한 값과 교환하며 정렬하는 알고리즘입니다. 정렬되지 않은 데이터가 많을수록 성능이 떨어지며, 시간복잡도가 O(n²) 입니다. 선택 정렬 구현 방법 배열을 선형 탐색하여 최소값을 선택하고,...","categories": ["python-java"],
        "tags": [],
