var store = [{
        ...
        "excerpt":"단방향 해시 복호화가 불가능하여 비밀번호 해싱에 적합합니다. 일반 해시 함수 MD5 128비트 고정 길이의 출력값을 가집니다. 보안이 취약해서 인증용으로 사용이 권장되지 않습니다. SHA-256 데이터 무결성 검증 등에 사용되는 해시 함수입니다. 속도가 빠르기 때문에 GPU 공격에 취약하여 비밀번호 저장 용도로는 부적합합니다. 사용자가 입력한 비밀번호를 해싱 후 SHA-256 해시 앞 16자리를 잘라서...","categories": ["web-dev"],
        "tags": [],
