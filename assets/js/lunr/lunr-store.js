var store = [{
        ...
        "title": "CS 면접 및 코딩테스트를 위한 알고리즘 개념 정리",
        "excerpt":"알고리즘 도감 앱을 함께 보면, 각 알고리즘 동작을 그림으로 쉽게 이해하고 복습하기 좋습니다. 정렬 알고리즘 정의된 순서대로 데이터를 나열하는 방법입니다. 버블 정렬 끝에서부터 서로 인접한 두 원소를 비교하며 순서를 정렬하는 알고리즘입니다. 코드가 단순하지만, 시간복잡도가 O(n²)으로 매우 느립니다. 버블 정렬 예시 배열의 한쪽 끝에서 두 원소를 비교하고, 순서에 맞지 않으면 위치를...","categories": ["python-java"],
        "tags": [],
        "url": "/python-java/2024-05-10-1",
        "teaser": null
      },{
