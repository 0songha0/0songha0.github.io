var store = [{
        ...
        "excerpt":"알고리즘 도감 앱을 함께 보면, 각 알고리즘 동작을 그림으로 쉽게 이해하고 복습하기 좋습니다. 정렬 알고리즘 정의된 순서대로 데이터를 나열하는 방법입니다. 선택 정렬 배열의 왼쪽 끝에서부터 차례로, 최소값과 위치를 교환하며 정렬하는 알고리즘입니다. 정렬되지 않은 데이터가 많을수록 성능이 떨어지며, 시간복잡도가 O(n²) 입니다. 선택 정렬 Java 코드 예시 int[] digits = { 5,...","categories": ["python-java"],
        "tags": [],
