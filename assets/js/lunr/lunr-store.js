var store = [{
        ...
        "excerpt":"Java 자료구조 Java 변수 타입 프리미티브 타입 (기본형) 메모리에 값을 직접 저장해서 연산 속도가 빠릅니다. 예시 : int, long, float, double, char 등 레퍼런스 타입 (참조형) 메모리에 값이 들어있는 객체의 주소를 저장합니다. 컬렉션 프레임워크에는 래퍼 클래스 객체처럼 레퍼런스 타입 데이터가 저장됩니다. 예시 : Integer, Long, Float, Double, Character 등 프리미티브...","categories": ["python-java"],
        "tags": [],
