...
<strong>1. </strong>Management 메뉴 > Data > Index Management  
logstash로 수집 시 자동 생성된 index명을 확인합니다.

<strong>2. </strong>Management 메뉴 > Kibana > Data Views > 우측 Create data view 버튼  
Name : index명* 으로 Data Views를 생성합니다.

<strong>3. </strong>Analytics 메뉴 > Discover  
