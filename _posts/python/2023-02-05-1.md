...
내부적으로 값을 순차적으로 동적 배열에 저장하여 크기를 조절합니다.
...
### Dictionary (사전)
파이썬 사전은 Java의 HashMap과 유사한 자료형이며, 순서가 없습니다.  
...
선언된 값을 변경할 수 없어서, 주로 변경하면 안 되는 서로 다른 성질의 데이터를 튜플로 관리합니다.  
...
## 파이썬 함수 및 라이브러리 사용법
<https://songha0.github.io/python/2023-02-15-1>{: target="_blank"}
