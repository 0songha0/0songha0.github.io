...
Git history로 파일 비교해보면 왼쪽이 이전 소스, 오른쪽이 변경된 소스입니다.

### Commit 제외 폴더 설정
.gitignore 파일에 명시하면 됩니다.

### 새로운 Git 저장소에 첫 소스 올리기
신규 프로젝트 만들고 상단 VCS > Enable Version Control Integration... > Git 선택 > OK > 좌측 Git 메뉴 > Unversioned Files 우클릭 > Add to VCS > Changes 파일들 체크 > Commit Message 작성 > Commit > 상단 Git > push > Define remote >
<table>
<tbody>
  <tr>
    <td>Name</td>
