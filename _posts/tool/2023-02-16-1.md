---
title: "DBeaver 설치 / 무료 데이터베이스 관리 툴 DBeaver 사용법 (작성중)"
excerpt: ""
...
### DB 연결 생성
좌측 Database Navigator 빈 공간 우클릭 > Create > Connection > DB 종류 선택 > 다음 > 아래 예시 참고하여 DB 정보 입력 >
<table>
  <tbody>
    <tr>
      <td>Server Host</td>
...
Test Connection 시 Connected 나오면 > 확인
