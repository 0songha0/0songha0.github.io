...
### 플러그인 및 마켓플레이스
File > Settings > Plugins > Marketplace 탭 > 플러그인 검색 및 설치  
Lombok, GitHub Copliot 등 유용한 플러그인들을 설치할 수 있습니다.  
프로젝트에서 Lombok을 사용하는데 플러그인을 사용하지 않으면 인식 오류가 표시될 수 있습니다.

<mark>코파일럿 기능 단축키</mark>
<table class="table_2_left">
  <tbody>
    <tr>
      <td>다음 단어까지 코드 제안 수락</td>
      <td>Ctrl + →</td>
    </tr>
    <tr>
      <td>코드 제안 전체 수락</td>
    ...
    <tr>
      <td>코파일럿 인라인 대화 열기</td>
      <td>Alt + Enter > Open GitHub Copilot Inline Chat 클릭</td>
    </tr>
  </tbody>
</table>
...
### Java 코드 실행 방법
Main 클래스 또는 main 함수 좌측 ▷ 버튼 클릭 > Run 'Main.main()' 클릭
