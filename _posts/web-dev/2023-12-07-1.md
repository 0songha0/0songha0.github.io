...
if(isAuthenticated) {
  ...
  // _sessid는 현재 세션 ID(예시 : 7CF30592B6FFCB7A4070A7F3BB598C19)에 특정 문자열과 난수를 더해서 AES256 암호화한 값입니다.
...
첫 번째 API에 _sessid를 파라미터로 넘기고, 인증 성공 시 유저 토큰을 받습니다.  
