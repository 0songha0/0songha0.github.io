...
public ModelAndView chekSession(HttpServletRequest req, HttpServletResponse res) throws Exception {
  ...
  IMLgnSttsVO lgnStts = lgnSttsService.selectDetailLgnStts(uniqId);
