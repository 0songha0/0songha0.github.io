---
title: "Java 정규표현식 사용법 / 특정 문자열 사이 추출"
excerpt: ""
...
```
정규표현식을 이용하여 _returnData = '와 '; 사이의 문자열을 추출합니다.