...
우측 상단 Edit Configurations > 추가된 Tomcat 선택 > Server 탭 > Before launch > + > Run Maven Goal > Command line : clean package -Denv=프로파일명 또는 package -Denv=프로파일명 입력 > OK > 추가한 Maven Goal이 Build 전에 위치하도록 수정 > Apply > OK  
