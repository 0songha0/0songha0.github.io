---
title: "egovFramework에서 Java 캐시 라이브러리 Ehcache 적용 방법"
excerpt: ""
...
```
캐시 구분에 따라 캐시를 다르게 설정할 수 있습니다.

<mark>Ehcache 캐시 설정 옵션</mark>
...
```
egovFramework에서 Ehcache 캐시를 사용하도록 설정합니다.

<mark>Spring ServletContextListener 설정 참고</mark>
```
