...
<table class="table_2_left">
  <tbody>
    ...
    <tr>
      <td>beforeMount</td>
      <td>onBeforeMount</td>
      <td>DOM에 컴포넌트가 부착되기 전</td>
    </tr>
    <tr>
      <td>mounted</td>
      <td>onMounted</td>
      <td>컴포넌트가 DOM에 마운트된 후</td>
    </tr>
    <tr>
      <td>beforeUpdate</td>
      <td>onBeforeUpdate</td>
      <td>반응형 상태 변경으로 DOM 업데이트 전</td>
    </tr>
    <tr>
      <td>updated</td>
      <td>onUpdated</td>
    ...
    <tr>
      ...
      <td>자식 컴포넌트에서 에러 발생 시</td>
    </tr>
    <tr>
      <td>renderTracked</td>
      <td>onRenderTracked</td>
      <td>반응형 데이터 추적 여부 확인 시 (디버깅 용도)</td>
    </tr>
    <tr>
      <td>renderTriggered</td>
      <td>onRenderTriggered</td>
      <td>반응형 데이터 변경으로 컴포넌트 렌더링 트리거 시 (디버깅 용도)</td>
    </tr>
    <tr>
      <td>activated</td>
      <td>onActivated</td>
      <td>keep-alive 컴포넌트 활성화 시</td>
    </tr>
    <tr>
      <td>deactivated</td>
      <td>onDeactivated</td>
      <td>keep-alive 컴포넌트 비활성화 시</td>
    </tr>
    <tr>
      <td>serverPrefetch</td>
      <td>onServerPrefetch</td>
      <td>SSR(서버 사이드 렌더링) 시 데이터 사전 로딩용</td>
    </tr>
  </tbody>
</table>
...
setup 라이프사이클 훅은 컴포넌트 인스턴스가 생성되기 전이기 때문에 this를 사용할 수 없습니다.  
mounted 라이프사이클 훅에서는 this로 app 인스턴스에 접근할 수 있습니다.
