...
### log4j
초기 많은 Java 어플리케이션에서 널리 사용되었습니다.
...
```
logback.xml 파일 생성 후 톰캣 재시작 시 즉시 적용됩니다.  
우선순위가 더 높은 application.properties에 로그레벨 설정이 있으면 logback.xml의 설정은 무시됩니다.
