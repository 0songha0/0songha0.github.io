...
포스트맨으로 허용되지 않는 DELETE, OPTIONS 같은 HTTP 메소드 요청 시 405 에러가 발생됩니다.

<mark>취약점 조치 방법 1</mark>  
...
<mark>취약점 조치 방법 2</mark>  
```
<Valve className="org.apache.catalina.valves.ErrorReportValve"
        showReport="false"
        showServerInfo="false" />
```
톰캣 server.xml 파일에 위 코드를 추가하면 모든 에러 코드에 대해 서버 종류 및 버전 정보가 노출되지 않습니다.
