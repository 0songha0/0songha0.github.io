...
<table class="table_2_left">
  <tbody>
    ...
    <tr>
      ...
      <td>
        공통 설정 또는 추가 서버 설정 파일<br>
        Ubuntu 보다는 CentOS 계열에서 주로 사용합니다.<br>
        해당 파일은 없어도 정상 동작합니다.
      </td>
    </tr>
    <tr>
...
<mark>Nginx 전체 서버 블록 확인 방법</mark>
```
...
```
Vue 페이지에 진입한 유저 디바이스 및 URL 정보를 실시간으로 확인할 수 있습니다.

### 에러 로그 확인
```
tail -100f /var/log/nginx/error.log
```
백엔드 요청 시 에러 로그 등을 확인할 수 있습니다.
