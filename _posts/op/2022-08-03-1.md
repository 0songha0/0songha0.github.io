...
*   Trying 211.47.4.169...
* TCP_NODELAY set
* connect to 211.47.4.169 port 443 failed: Connection timed out
* Failed to connect to gpt.chunjae.co.kr port 443: Connection timed out
* Closing connection 0
curl: (7) Failed to connect to gpt.chunjae.co.kr port 443: Connection timed out
```
서버에서 응답을 받을 수 없는 경우의 메세지입니다.
