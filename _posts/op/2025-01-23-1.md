...
public void set배멸명(String[] 배멸명) {
  if (배멸명 != null) {
    this.배멸명 = new String[배멸명.length];
    System.arraycopy(배멸명, 0, this.배멸명, 0, 배멸명.length);
  } else {
    this.배멸명 = null;
  }
}
...
```
public void set배멸명(String[] 배멸명) {
  this.배멸명 = (배멸명 == null) ? null : Arrays.copyOf(배멸명, 배멸명.length);
}
```
