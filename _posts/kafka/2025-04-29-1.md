---
title: "아파치 카프카 설정 방법 / 카프카 CLI 스크립트 종류"
excerpt: ""
...
Kafka CLI 도구는 카프카 설치 시 함께 제공되는 쉘 스크립트 (.sh 또는 .bat) 실행 파일입니다.  
카프카 클러스터 운영 및 관리를 위한 기능들을 CLI (Command Line Interface) 형태로 제공합니다.
