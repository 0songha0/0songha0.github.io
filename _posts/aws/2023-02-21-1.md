---
title: "SpringBoot에서 AWS S3 파일 업로드 및 다운로드 Java 유틸 개발"
excerpt: ""
...
### 현재 폴더에 몇 번째 폴더가 있는지 확인 후 새 폴더명 번호 생성
```
int folderCnt = 0;
...
### S3 파일 업로드 호출부
```
Map<String, Object> fileUploadResult = s3Util.uploadFile("폴더명/하위폴더명, file);
```
